...
func (c *productsClient) Fetch(ctx context.Context, in *FetchRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/products_svc.Products/Fetch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productsClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/products_svc.Products/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProductsServer) Fetch(context.Context, *FetchRequest) (*empty.Empty, error) {
...
func _Products_Fetch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/products_svc.Products/Fetch",
	}
...
func _Products_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/products_svc.Products/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Products_serviceDesc = grpc.ServiceDesc{
	ServiceName: "products_svc.Products",
